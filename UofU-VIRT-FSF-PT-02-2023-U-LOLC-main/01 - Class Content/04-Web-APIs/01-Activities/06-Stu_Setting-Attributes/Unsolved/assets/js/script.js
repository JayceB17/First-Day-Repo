...
var h4 = document.querySelector("style", "color:red; font-size: 30px; bold");
for (var i = 0; i < site1El.lastElementChild; i++){
    site1El[i].setAttribute("style", "color:red; font-size: 30px; bold");
}s